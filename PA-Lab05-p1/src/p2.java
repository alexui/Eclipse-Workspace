...
class Move2 {
    ...
    public Move2(int player, int x, int y) {
        this.player = player; /* Jucatorul care face mutarea */
        this.x = x; /* Linia */
        this.y = y; /* Coloana */
    }

    public Move2(int player) {
        this(player, -1, -1);
    }
}
...
class Reversi {
    ...
    public boolean ended() {
        for (int i = 0; i < N; i++)
            for (int j = 0; j < N; j++) {
                ...
                if (tmp.apply_move(new Move2(1, i, j)))
                    return false;
     ...
     */
    public boolean apply_move(Move2 move) {
...
class P2 {
    ...
    static Pair<Integer, Move2> minimax(Reversi init, int player, int depth) {
        /**
        ...
        return new Pair<Integer, Move2>(-Reversi.Inf, new Move2(player));
    }
     ...
     */
    static Pair<Integer, Move2> minimax_abeta(Reversi init, int player, int depth, int alfa, int beta) {
        /* Conditia de oprire */
            ...
            if (player == 1) {
                ...
                if (!HUMAN_PLAYER) {
                    ...
                    while (!valid) {
                        ...
                        valid = rev.apply_move(new Move2(player, x, y));
                    }
                }
            }
