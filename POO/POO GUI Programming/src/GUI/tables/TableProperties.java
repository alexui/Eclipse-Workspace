...
public class TableProperties extends JFrame {
	private static final long serialVersionUID = 7976160034393898499L;
	...
	private JComboBox<String> jcboAutoResizeMode = new JComboBox<String>(
			new String[] { "AUTO_RESIZE_OFF", "AUTO_RESIZE_LAST_COLUMN",
					"AUTO_RESIZE_SUBSEQUENT_COLUMNS",
					"AUTO_RESIZE_NEXT_COLUMN", "AUTO_RESIZE_ALL_COLUMNS" });
	...
	public static void main(String[] args) {
		TableProperties frame = new TableProperties();
		frame.setDefaultCloseOperation(EXIT_ON_CLOSE);
		frame.setTitle("TableProperties");
