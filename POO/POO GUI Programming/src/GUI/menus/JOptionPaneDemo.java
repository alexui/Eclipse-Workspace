...
public class JOptionPaneDemo {
	public static void main(String args[]) {
		...
		Object annualInterstRateObject = JOptionPane.showInputDialog(null,
				"Select annual interest rate:", "JOptionPaneDemo",
				JOptionPane.QUESTION_MESSAGE, null, rateList, null);
		double annualInterestRate = ((Double) annualInterstRateObject)
				.doubleValue();
		...
		String output = "Interest Rate: " + annualInterestRate + "%"
				...
				+ loanAmount;
		output += "\nMonthly Payment: " + "$" + (int) (monthlyPayment * 100)
				/ 100.0;
		output += "\nTotal Payment: $"
